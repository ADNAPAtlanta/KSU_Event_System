...
class eventForm:
    def __init__(self,master):
        self.master = master
        master.title("KSU Event System")
        master.minsize(width=340,height=300)
        self.type = StringVar()
        ...
        self.dateLabel.grid(row=1,column=3)
        self.dateEntry = Entry(master,bd=3,textvariable=self.date)
        self.dateEntry.grid(row=2,column=3,padx=5)
        
        self.descriptionLabel = Label(master, text="Description",underline=0)
        self.descriptionLabel.grid(row=3,column=2)
        self.descriptionEntry = Text(master,bd=3,height=5)
        self.descriptionEntry.grid(row=4,column=1,columnspan=3)

        self.buildingLabel = Label(master, text="Building",underline=0)
        self.buildingLabel.grid(row=5,column=1)
        self.building.set("Select building.")
